...
ATTRACT: Job posting optimization (which roles to advertise, where, to whom). Programmatic job advertising (algorithmic targeting of candidates — Facebook housing ad risk applies here). Candidate sourcing (AI-generated prospect lists from professional networking platforms).
