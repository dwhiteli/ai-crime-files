...

{
  ...
  readTime: 40,
  listenTime: 25,
  teaser: "Illinois, Colorado, California, and more: state AI laws are creating a complex compliance landscape that HR can't afford to ignore.",
  content: [
    {
      type: "scene",
    ...
    {
      type: "case-intro",
      caseNumber: "STATE LAW SNAPSHOT 2024–2025",
      heading: "The Laws You Need to Know",
      location: "Multiple US States",
      text: "ILLINOIS — AI Video Interview Act (2020): The first state AI employment law. Requires employers using AI to analyze video interviews to notify candidates before the interview, explain how the AI works, get consent, and limit who can access the videos. One of the narrower laws — only covers video interviews — but was the first domino.\n\nNEW YORK CITY — Local Law 144 (effective 2023): Already covered in Day 11. The gold standard for bias audit requirements.\n\nCOLORADO — SB 205 (2024): Applies to deployers of 'high-risk' AI systems in consequential decisions including employment. Requires risk management programs, impact assessments, annual reviews, candidate notices, the right to correct data, an appeals path, and public disclosures. One of the most comprehensive state laws in the US.\n\nCALIFORNIA — CRCA and California Civil Rights Council Regulations (2024): California's Civil Rights Council approved regulations explicitly applying the state's anti-discrimination law to automated employment decision systems. A company using AI in hiring in California faces the same disparate impact standards as a company using human decision-makers.\n\nMARYLAND: Prohibits employers from using facial recognition during job interviews without applicant consent.\n\nNATIONAL CONFERENCE OF STATE LEGISLATURES tracks all state AI bills. As of 2025, dozens of states have active AI legislation in various stages."
    },
    {
      type: "finding",
