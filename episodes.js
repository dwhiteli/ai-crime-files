...

{
  ...
  content: [
    ...
    {
      type: "case-intro",
      caseNumber: "AMAZON TOT — Composite",
      heading: "The Warehouse Worker",
      location: "Drawn from documented cases",
...

{
  ...
  content: [
    ...
    {
      type: "icm",
      text: "ICM — Interpretable Context Methodology — has a core principle called \"observe before you build\": map what actually happens when a human makes this decision before you automate it. Watch the human first. Design second.\n\nAmazon's team skipped this step. They never asked: when a human recruiter makes a good hire, what are they actually evaluating — and is our historical hiring data a valid record of those evaluations, or a record of the biases that came with them?\n\nIf they had observed before they built, they would have found that 10 years of hiring decisions in tech were not a neutral signal. The pattern they were about to train the algorithm on was already compromised at the source.\n\nThe 60/30/10 principle applies here too. ICM places a human recruiter above the workflow as the operator and bounds what sits below: 60% of the hiring process can be deterministic (did they meet the qualifications?), 30% can be rules-based (do they pass the structured screen?), and 10% is the AI's ceiling — its pattern-matching signal is one input, capped at 10% of the decision weight. The qualitative judgment about potential and fit lives with the human operator above the stack, not inside any percentage layer.\n\nAmazon let the AI carry 100% of the decision — including the qualitative slot that belongs to the human above the stack. The rules layer was unbuilt and the human operator role was vacated. Observe-before-you-build would have caught that before any code was written."
    },
    {
      type: "terms",
      terms: [
...

{
  ...
  readTime: 45,
  listenTime: 30,
  teaser: "Amazon, IBM, and others: AI systems recommending who to fire — and a manager approving the recommendation in thirty seconds. The question of who actually made the decision still doesn't have a clean answer.",
  content: [
    {
      type: "scene",
...

{
  ...
  content: [
    ...
    {
      type: "icm",
      text: "ICM's 60/30/10 principle is a useful lens for reading corporate AI ethics commitments — specifically for separating real governance from branding.\n\nA principles document lives entirely in the values layer — what the company says it believes. It doesn't tell you whether those beliefs constrain any actual code, rules, or AI behavior. There is no human operator above the stack named, no rules layer specified, no ceiling on the AI's share of decisions.\n\nA governance document adds the rules layer (30%). Microsoft's Responsible AI Standard is a real example: it specifies required documentation, named responsibilities, and checkpoints before deployment. When you read it, you can see the rules that govern the code and the human operator who applies them.\n\nA governance system adds the monitoring layer: is the code actually running the way the rules require? Is the AI's role bounded at its 10% ceiling? Is the human operator engaged? Is someone checking? Is there a consequence when the answer is no?\n\nMost corporate AI ethics pages are at level one — a statement of what the company believes. A small number are at level two — specific rules that constrain what gets shipped and name the human operator above the workflow. Almost none are verifiably at level three — because demonstrating that the rules are enforced and the AI's ceiling holds continuously requires ongoing transparency that most companies haven't committed to.\n\nWhen you evaluate a vendor's ethics commitments, ask: does this document live in the values layer, the rules layer, or the monitoring layer? Does it name the human operator above the stack and the AI's bounded share? Your governance exposure depends on the answer."
    },
    {
      type: "terms",
      terms: [
...

{
  ...
  readTime: 40,
  listenTime: 25,
  teaser: "Connecticut passed a new AI employment law in April 2026. California's opt-out rights took effect January 1. The state AI law patchwork is expanding faster than most HR programs can track.",
  content: [
    {
      type: "scene",
...

{
  ...
  content: [
    ...
    {
      type: "icm",
      text: "The score card is what makes governance continuous instead of episodic — and it maps directly onto 60/30/10.\n\n— Code monitoring (60%): are the AI systems in your inventory running as documented? Have there been model changes, feature updates, or vendor changes that altered what the code does? Inventory health metrics catch this layer.\n— Rules monitoring (30%): are the rules layer requirements being followed? Are intake processes being completed before deployment? Are bias audits running on schedule? Are accommodation requests being tracked and resolved? Process compliance metrics catch this layer.\n— AI ceiling monitoring (10%): is the AI's share of the decision actually bounded at 10%, or has automation drift expanded its role into the entire decision? Override rates approaching zero are the signal that the ceiling has failed.\n— Human operator monitoring (above the stack): is the named operator engaged, or has the role collapsed into ceremonial approval? Outcome metrics — adverse impact ratios, complaint volumes, override rates — catch this.\n\nThe CFPB finding was damning precisely because the organizations involved were measuring activity (did reviews happen?) but not outcomes (did the tool harm protected groups?). A complete score card measures all three layers.\n\nAt SummitPeak Systems — which you'll meet tomorrow — none of these metrics existed. The code ran. The rules weren't written. The AI's 10% ceiling was never bounded. The human operator role was never monitored. And by the time the EEOC charge arrived, the evidence gap was years wide."
    },
    {
      type: "terms",
      terms: [
